...
public abstract class MultiTouchEntity implements Serializable {
	...
	public void reload(Context context) {
		System.out.println("the cotext object" + context);
		mFirstLoad = false; // Let the load know properties have changed so
							// reload those,
							// don't go back and start with defaults
		load(mDrawable, context, mCenterX, mCenterY);
	}

	public abstract void draw(Canvas canvas);

	public abstract void load(Drawable bg, Context context, float startMidX,
			float startMidY);
